...
RESOURCES_DIRECTORY_PATH = REPOSITORY_ROOT_PATH.joinpath("resources")
SCENES_DIRECTORY_PATH = RESOURCES_DIRECTORY_PATH.joinpath("scenes")
RENDERS_DIRECTORY_PATH = RESOURCES_DIRECTORY_PATH.joinpath("renders")
# ===
